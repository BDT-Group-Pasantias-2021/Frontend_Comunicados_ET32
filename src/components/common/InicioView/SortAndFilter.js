...
export default function SortAndFilter() {
	const selectFiltro = () => {
		...
		if (valorSelect.value !== null || valorSelect.value !== '') {
			if (valorSelect.value === 'Leido') {
				return 'search_leido_comunicados';
			} else if (valorSelect.value === 'No leido') {
				return 'search_no_leido_comunicados';
			} else {
				return 'search_titulo_comunicados';
			}
		}
	};
	return (
		<div className="filter-bar-container col-11 col-sm-12 col-md-10">
			...
			<div className="standard-icon-container standard-icon-container-margin">
				...
				<select name="select-comunicado" id="select-comunicados">
