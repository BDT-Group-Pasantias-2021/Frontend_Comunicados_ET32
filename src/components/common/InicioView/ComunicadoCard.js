		...
		<div className="comunicado-card-container" id={`comunicado-card-container${cardId}`}>
			...
			<ul className="comunicado-options-menu" id={`comunicado-options-menu${cardId}`}>
				<li className="comunicado-function">
					...
					<p className="comunicado-function-label">Editar comunicado</p>
				</li>
				<li className="comunicado-function">
					<svg className="comunicado-function-icon" id="Capa_1" viewBox="0 0 512 512">
						<g>
							<g>
								<path
			...
			C426.667,134.976,412.309,149.333,394.667,149.333z"
				...
				<li className="comunicado-function">
					...
					<p className="comunicado-function-label">Eliminar comunicado</p>
				</li>
			</ul>
		</div>
	);
